...
export const homeOriginContent: HomeOriginContent = {
	...
	ipIntro: [
		"童蒙家塾，起源于真实存在的传统文化传承之家，是以三代同堂的真实生活为原型诞生的国风原创家庭 IP。",
		"童蒙家塾所有故事皆取材于家庭的日常点滴，灵感源自真实的生活轨迹。",
		"我们以家为塾，致力于学习中华优秀传统文化、承袭中华千年家风美德、践行传统童蒙教养智慧与东方生活哲思，用正能量的动画影像，呈现传统文化经典的智慧底蕴、当代中国式家庭的温润底色与家风家学传承之美。",
	],
	brandVision: [
		"童蒙家塾的家庭成员，在日常生活中深受优秀传统文化滋养，在长辈榜样带动与家庭共同学习的氛围中，各家庭成员努力践行修身立德、和睦齐家之道。",
		"我们循「修身、齐家、治国、平天下」的理想，愿通过家庭动画的形式传递经典智慧、弘扬经典，推动优秀传统文化浸润社会、温润人心，一起守护人人正向成长，促进社会和谐、家庭和美，共赴世宁人和的美好愿景。",
	],
};
